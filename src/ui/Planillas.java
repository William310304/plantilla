...
public class Planillas extends JFrame implements Runnable {
	...
	public static boolean bEdicion = false;
	...
	public Planillas() {
		...
		lblMensaje.setBounds(20, 60, 1260, 39);
				...
				switch (subMenu) {
					...
					case 2: 
						switch (index) {
							case 1: break;
							case 2: break;
							case 3: pnl = new Sede(); break;
							case 4: pnl = new CentroConsto(); break;
							case 5: pnl = new Cargos(); break;
							case 6: pnl = new Departamento(); break;
							case 7: break;
						}
					break;
				}
